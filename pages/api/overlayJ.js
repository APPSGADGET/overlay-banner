...
const fontFiles = {
  ...
  montserratBlack: path.join(fontsDir, 'Montserrat-Black.ttf'),
...
fontBase64Cache = {
  ...
  montserratBlack: loadFontAsBase64(fontFiles.montserratBlack, 'Montserrat Black'),
...
const tagalogQuotes = [
  ...
  "…"
    ...
    // Parse show border parameter (sb) - false by default, set to true or 1 to show
   ...
   'WOW'
    ...
    const fontFaceDeclarations = `
      ...
      @font-face {
        ...
        font-style: normal;
        font-display: block;
        src: url('${fontBase64Cache.montserratBlack || ''}') format('truetype');
      }
      @font-face {
