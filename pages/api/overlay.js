...
const tagalogQuotes = [
  ...
  'URGENT', 'USB-C', 'VIRAL', 'WATERPROOF', 'WEARABLE', 'WIFI 7', 'WIN', 
   ...
   'HOME CREDIT', 'NUBIA', 'INFINIX', 'TECNO', 'ITEL',
    ...
    'vivo', 'OPPO', 'XIAOMI', 'ONEPLUS', 'REALME', 'LENOVO', 'ASUS', 'DELL', 'HP', 'MICROSOFT', 'GOOGLE', 'SONY', 'LG', 'ACER', 'NOKIA', 'MOTOROLA', 'AMAZON', 'META', 'TESLA', 'INTEL', 'AMD', 'NVIDIA', 'ROG', 'RAZER',

    'FYP', 'FOR YOU', 'FOR YOU PAGE', 'TRENDING NOW', 'VIRAL VIDEO',
    'SCRIPPS', 'DAILYMAIL', 'BUZZFEED', 'INSIDER', 'LAD BIBLE',
    'EPIC', 'LEGENDARY',
    'CHINA', 'INDIA', 'JAPAN', 'SOUTH KOREA', 'BRAZIL', 'MEXICO',
    'WARNER BROS.', 'UNIVERSAL PICTURES', 'PARAMOUNT PICTURES',
    'COLUMBIA PICTURES', '20TH CENTURY STUDIOS', 'LIONSGATE',
    'AMC THEATERS', 'REGAL CINEMAS', 'CINEMARK','PARAMOUNT',
    'USA', 'UK', 'CANADA', 'AUSTRALIA', 'NEW ZEALAND',
    'SINGAPORE', 'MALAYSIA', 'THAILAND', 'VIETNAM', 'INDONESIA','EU',
    'ASEAN', 'NORTH AMERICA', 'SOUTH AMERICA', 'EUROPE', 'AFRICA',
    'EUROPE', 'ASIA', 'OCEANIA','PHILIPPINES','FILIPINOS','PINOY',
    'LIT', 'FIRE', 'DOPE',
    'INSTAGRAM', 'FACEBOOK', 'TWITTER', 'SNAPCHAT', 'TIKTOK', 'LINKEDIN',
    'AI-RELATED', 'AI-DRIVEN', 'AI-POWERED', 'AI-ENHANCED', 'AI-ASSISTED',

    'VIVO V60', 'OPPO RENO8', 'XIAOMI REDMI NOTE 12', 'ONEPLUS NORD CE 3', 'REALME 10 PRO+',
    'SAMSUNG GALAXY S23', 'SAMSUNG GALAXY A14', 'HUAWEI P50 POCKET',
    'GOOGLE PIXEL 7A', 'GOOGLE PIXEL 8',

    'IPHONE', 'IPAD', 'MACBOOK', 'IMAC', 'AIRPODS',
    'GALAXY', 'NOTE', 'SERO', 'TAB S8', 'WATCH',
    'PIXEL', 'NEXUS',
    'SURFACE', 'XBOX', 'PLAYSTATION', 'PS5', 'PS4',

    'HOME CREDIT', 'NUBIA', 'INFINIX', 'TECNO', 'ITEL',
    'SPOTIFY', 'NETFLIX', 'DISNEY+', 'HULU', 'AMAZON PRIME', 'HBO MAX',
    'CHATGPT', 'DALLE', 'MIDJOURNEY', 'STABLEDIFFUSION', 'OPENAI',

    'VIVO X300', 'OPPO FIND N2', 'XIAOMI MIX FOLD 3', 'ONEPLUS 11T', 'REALME GT 3',
    'TESLA MODEL 3', 'TESLA MODEL Y', 'TESLA MODEL S', 'TESLA MODEL X',

    'GLOBE','SMART','DITO','SUN','TM',

    'STOCKS', 'CRYPTO', 'BITCOIN', 'ETHEREUM', 'BLOCKCHAIN',
    'NFT', 'METAVERSE',

    'ALPHABET', 'GOOGL', 'GOOG', 'AMAZON', 'AAPL', 'APPLE', 'MICROSOFT', 'MSFT', 'TESLA', 'TSLA', 'META', 'FB', 'FACEBOOK',
    'NVIDIA', 'NVDA', 'AMD', 'INTEL', 'IBM', 'ORACLE', 'SAP',

    'META', 'FACEBOOK', 'INSTAGRAM', 'WHATSAPP', 'OCULUS',
    'DISNEY', 'PIXAR', 'MARVEL', 'STAR WARS',

    'WAYMOSE', 'LYFT', 'UBER',
    'NFLX', 'DISNEY+', 'HBO MAX', 'SPOTIFY','PERMIRA','SILVER LAKE',
